...
public class D14P2 {
	...
	public static int ans() {
		...
		// expand grid
		yMax += 2;
		xMin = Math.min(xMin, 500 - yMax - 1);
		xMax = Math.max(xMax, 500 + yMax + 1);
		...
		while (true) {
			...
			while (true) {
				...
				} catch (IndexOutOfBoundsException e) {out = true; curr.b++; System.out.println("bruhbruh");}
				...
				} catch (IndexOutOfBoundsException e) {out = true; curr.b++; curr.a--; System.out.println("bruhbruh");}
